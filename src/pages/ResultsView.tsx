  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: 'var(--color-bg-secondary)' }}>
      ...
      <div className="flex flex-1">
        ...
        {/* Main Content */}
        <main className="flex-1 overflow-y-auto flex justify-center" style={{ backgroundColor: 'var(--color-bg-secondary)' }}>
            ...
            <div className="w-full max-w-6xl px-8 py-8">
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 gap-8" style={{ gridTemplateColumns: 'minmax(0,5fr) minmax(0,7fr)' }}>
                  ...
                  <Card className="shadow-sm overflow-hidden" style={{ padding: 0 }}>
                    <div className="flex items-start gap-2 px-6 pt-5 pb-3">
                      <span className="text-lg leading-none flex items-center mt-0.5">🏆</span>
                      <div>
